...
**/
size_t GF_shmChkSize (size_t insize, size_t base)
{
int outsize;
...
size_t size;
	...
	size = GF_shmChkSize (size, getpagesize());
#else
	size = GF_shmChkSize (size, PAGE_SIZE);
#endif
	*psize = size;
