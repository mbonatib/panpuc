...
static char rcsid_fundtypes[] = "$Id: //lvdist/releases/6.0/plat/win/cintools/fundtypes.h#2 $";
#endif
...
#include "platdefines.h"
	...
	typedef double				float64;
	#define ExtHiLo 0
	#if Processor==kPARISC || Processor==kMIPS || Processor==kDECAlpha || OpSystem == kBeOS || OpSystem == kAIX || (Linux && PowerPC)
...
/* Get the system definitions for 
	...
	#endif
#else
	#error Need to find out where to get stddef defines for WinCE
#endif /* WinCE */
