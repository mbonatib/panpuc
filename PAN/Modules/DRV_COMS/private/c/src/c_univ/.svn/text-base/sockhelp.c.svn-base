...
/* NOTE: the function get_connection which was defined here has been
 * removed. We never used it anyway, and it conflicted with another
 * function of the same name in the Postgres ecpg libraries, causing
 * a fatal error. -- ajwm, 10/15/2000
 */
