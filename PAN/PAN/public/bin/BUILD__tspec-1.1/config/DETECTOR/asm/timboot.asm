...
ST_CDS	EQU	17	; Set if in correlated double sample radout mode
...
TWO_XMTR	EQU	$060000		; Two fiber optic transmitters on ARC-22
...
STATUS	DC	$100004			; Controller status bits
...
LATCH		DC      $32		; Starting value in latch chip U25
